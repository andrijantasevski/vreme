...
export default function Forecast7Days({ forecast }: any) {
    const forecast7Days = forecast.daily.slice(1).map((day: any) => <ForecastSingleDay key={day.dt} dayOfWeek={day.dt} minTemp={day.temp.min} maxTemp={day.temp.max} icon={day.weather[0].icon} />)
